...
<link
	href="/Project_Frontend/src/main/webapp/WEB-INF/resources/css/custom.css"
	rel="stylesheet">
<script
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<c:url value="/resources/images/Sony.jpg" var="url5"></c:url>
			<c:url value="/home" var="url1"></c:url>
			<a class="navbar-brand" href="${url1 }"><img
				src="${url5 }" alt="PHOTOMANIA" height="30px" width="30px"></a>
		</div>
		<div class="collapse navbar-collapse" id="collapse-example">
			<ul class="nav navbar-nav">
				...
				<li><security:authorize access="hasRole('ROLE_USER')">
						<li><c:url value="/cart/getcart" var="urlCart"></c:url> <a
